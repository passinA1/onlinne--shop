...
foreach($arr  as $key => $value){ ?>
				<li>
					...
					<div class="item-pic"><a>
						<img alt="item 1" src="<?php echo $pic[$key]?>" title="商品1" width="240" height="240"></a>
						</div>
					...
					<div>
						<form action = "change.php" method = "get">																
								...
								<div id="i2">
									<button class="btn btn-block btn-info">Change</button><span id="p111"></span>
								</div>
						</form>				
					</div>
					<div id="i2">
						<form method="post" href="">
						<a href="delete.php?product_id=<?php echo $p_id[$key]?>" class="btn btn-block btn-info">Delete</a>
						</form>							
					</div>	
...
<?php }?>
	...
	<div id="upload">
		...
		<form action = "addproduct.php" method = "get">																
			...
			<div id="i2">
				<button class="btn btn-block btn-info">Add Product</button><span id="p111"></span>
			</div>
		</form>	
	</div>			
</body>
